...
<?php include('includes/navbar.php') ?>
    ...
    <section class="page-title-layout1 page-title-light text-center bg-overlay bg-parallax">
      <div class="bg-img"><img src="assets/images/banners/product1.png" alt="background"></div>
      <div class="container">
        <div class="row">
          ...
          <h1 class="pagetitle-heading">Products</h1>
            ...
            <!-- <div class="d-flex flex-wrap align-items-center justify-content-center">
              <a href="home-supllies.html" class="btn btn-white mb-10 mx-3">
        ...
        <div class="row">
          <div class="col-sm-12 col-md-8 col-lg-9">
            <!-- <div class="sorting-options d-flex flex-wrap justify-content-between align-items-center mb-30">
              <strong>Showing 1:9 of 45 product</strong>
              <select>
